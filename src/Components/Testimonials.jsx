        ...
        <div>
            ...
            <div className="testimonials-heading">
              ...
              <div  className='image-body'>
                 <div> <img src="public\assets\Group 481960.png" alt="" /></div>
                 </div>
                <div  className='para-body'>
                    <img src="public\assets\Group.png" alt=""   className='colon-img'  style={{marginBottom:"100px", marginRight:"10px"}} />
                    ...
                    <img src="public\assets\Group (1).png" alt=""   className='colon-img'  style={{marginTop:"100px", marginLeft:"10px"}}  />
                </div>
            </section>

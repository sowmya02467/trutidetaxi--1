      ...
      <div className='div-right'>
        <div className='div2'>
          <div className='div-content'>
            ...
            <img src='Assets/Android.png' style={{width: '120px', height: '120px', marginBottom: '160px', marginRight: '-20px'}} alt='Android'></img>
          </div>
        </div>
        <div className='div3'>
          <div className='div-content'>
            ...
            <img src='Assets/Apple.png' style={{width: '100px', height: '100px', marginTop: '160px', marginRight: '-20px'}} alt='Apple'></img>
          </div>
        </div>
      </div>
    </div>

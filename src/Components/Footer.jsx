      ...
      <section className='footer'>
        ...
        <div className='orange'>
          ...
          <div className='footer-img'>
            <img src='Assets/AppStore.png' className='appstore' alt='appstore' />
            <img src='Assets/PlayStore.png' className='googleplay' alt='googleplay' style={{ marginLeft: '20px' }} />
          </div>
        </div>
        ...
        <div className='black'>
          <div className='div-Fleft'>
            <div>
              <img className='Flogo' src='Assets/fotterlogo.png' alt='Footer Logo' />
            </div>
            <div className='Dtext'>
